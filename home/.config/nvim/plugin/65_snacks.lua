...
end, "SNACKS Git Status")

nmap("<leader>gb", function()
	Snacks.git.blame_line()
end, "SNACKS Git Blame")
...
end, "SNACKS Go To Definition")

nmap("gD", function()
	Snacks.picker.lsp_declarations()
end, "SNACKS Go To Declaration")
...
end, "SNACKS Go To Implementation")

nmap("gy", function()
	Snacks.picker.lsp_type_definitions()
end, "SNACKS Go To T[y]pe Definition")
